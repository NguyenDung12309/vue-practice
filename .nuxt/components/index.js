export const ButtonLink = () => import('../../components/button/buttonLink.vue' /* webpackChunkName: "components/button-link" */).then(c => wrapFunctional(c.default || c))
...
export const MessageError = () => import('../../components/input/messageError.vue' /* webpackChunkName: "components/message-error" */).then(c => wrapFunctional(c.default || c))
...
export const TextNormal = () => import('../../components/text/textNormal.vue' /* webpackChunkName: "components/text-normal" */).then(c => wrapFunctional(c.default || c))
export const TextSpecial = () => import('../../components/text/textSpecial.vue' /* webpackChunkName: "components/text-special" */).then(c => wrapFunctional(c.default || c))
